...
-- Задание №1
insert into Teacher values (11,'Калинин', 'Никита', '19870223', null);
insert into Teacher_Course_Faculty values (15, 11, 2, 1, 100);

-- Задание №2
Update Student_grade set grade = grade+1 where course_id = 3